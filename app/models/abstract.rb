  ...
  def create_tags
    ...
    tags.each do |tag|
      if !not_tags.include?(tag)
        ...
        abst_logger.info("AbstractTag: #{abstract_tag_temp.tag_id}")
      end
    end
    abst_logger.info("\n")
  end
