class Connection < ActiveRecord::Base
  ...
  def self.my_logger
    @@my_logger ||= Logger.new("#{Rails.root}/log/logfile")
  end
  ...
  def self.compare(tags1, tags2)
    ...
    return 0 if intersection.size == tags1.size && intersection.size == tags2.size
