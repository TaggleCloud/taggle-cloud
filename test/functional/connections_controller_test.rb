...
class ConnectionsControllerTest < ActionController::TestCase
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post :create, connection: { conference_id: @connection.conference_id, user1_id: @connection.user1_id, user2_int: @connection.user2_int }
    end
  ...
  test "should update connection" do
    put :update, id: @connection, connection: { conference_id: @connection.conference_id, user1_id: @connection.user1_id, user2_int: @connection.user2_int }
    assert_redirected_to connection_path(assigns(:connection))
  end
